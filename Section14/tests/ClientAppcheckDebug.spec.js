...
test(`Client App login for ${data.productName}`, async ({ page }) => {
   ...
   await LP.validlogin(data.email,data.password)
   ...
   await DB.searchProductAddCart(data.productName)
  ...
  // await page.locator("[routerlink*='cart']").click();
   ...
   await CP.VerifyProductIsDisplayed(data.productName)
   await CP.checkout()
   ...
   await OR.VerifyEmailId(data.email)
